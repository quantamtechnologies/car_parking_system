...
class _ReportsScreenState extends State<ReportsScreen> {
  ...
  Future<_ReportsBundle> _load() async {
    ...
    final weekStartKey = DateFormat('yyyy-MM-dd')
                          ...
                          children: [
                            ...
                            Text(
                              ...
                              style: const TextStyle(
                                  color: Color(0xFF667085), height: 1.45),
                            ),
            ...
            final peakBars = today.peakHours
                .map(
                  (point) => ChartBarData(
                    ...
                    value: (point['total'] is num
                        ? (point['total'] as num).toDouble()
                        : 0),
...
String _hourLabel(dynamic hour) {
  final value =
      hour is num ? hour.toInt() : int.tryParse(hour?.toString() ?? '') ?? 0;
