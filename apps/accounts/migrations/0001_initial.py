    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Admin'), ('CASHIER', 'Cashier'), ('SECURITY', 'Security')], default='CASHIER', max_length=20)),
                ('phone_number', models.CharField(blank=True, max_length=32)),
                ('employee_code', models.CharField(blank=True, db_index=True, max_length=32)),
